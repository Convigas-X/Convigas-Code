...
// Create a custom hook to connect to the convigas_codeHistory database
...
export function DataTab() {
  // Use our custom hook for the convigas_codeHistory database
  ...
  // Data operations hook with convigas_codeHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
    ...
    customDb: db || undefined, // Pass the convigas_codeHistory database, converting null to undefined
  ...
  useEffect(() => {
    if (db) {
      console.log('Loading chats from convigas_codeHistory database', {
        name: db.name,
        version: db.version,

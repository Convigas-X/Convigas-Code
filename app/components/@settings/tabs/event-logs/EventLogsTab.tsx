...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with Convigas-Code
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('Convigas-Code - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by Convigas-Code', margin, doc.internal.pageSize.getHeight() - 10);

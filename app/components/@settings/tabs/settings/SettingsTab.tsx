...
export default function SettingsTab() {
  ...
  const [settings, setSettings] = useState<UserProfile>(() => {
    const saved = localStorage.getItem('convigas_code_user_profile');
    return saved
      ? JSON.parse(saved)
      : {
          notifications: true,
  ...
  useEffect(() => {
    try {
      ...
      const existingProfile = JSON.parse(localStorage.getItem('convigas_code_user_profile') || '{}');
      ...
      localStorage.setItem('convigas_code_user_profile', JSON.stringify(updatedProfile));
              ...
              onCheckedChange={(checked) => {
                ...
                window.dispatchEvent(
                  new StorageEvent('storage', {
                    key: 'convigas_code_user_profile',
